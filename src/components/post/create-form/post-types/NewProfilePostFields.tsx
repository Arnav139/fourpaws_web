    ...
    <div className="space-y-6">
          ...
          <FormItem>
            ...
            <Select onValueChange={field.onChange} defaultValue={field.value}>
              ...
              <SelectContent>
                ...
                <SelectItem value="dog_category" disabled>
                  Dogs
                </SelectItem>
                ...
                <SelectItem value="cat_category" disabled>
                  Cats
                </SelectItem>
                ...
                <SelectItem value="other_category" disabled>
                  Other Pets
                </SelectItem>
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem
            className={
              control._formValues.petBreed === "other_custom"
                ? "block"
                : "hidden"
            }
          >
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <FormDescription>Approximate age if known</FormDescription>
            <FormMessage />
          </FormItem>
        )}
      />
